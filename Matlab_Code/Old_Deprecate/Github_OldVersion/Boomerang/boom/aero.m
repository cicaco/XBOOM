...
R=0.30; %m
c=0.0488; %m
xac=0.0723+0.145; %va cambiato tra prima e seconda pala (DA FARE)
...
%SECONDA PALA
xac=0.0723+c/2+0.145; %va cambiato tra prima e seconda pala (DA FARE)
