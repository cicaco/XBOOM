...
T_0025=readmatrix('ProfiloPiatto_T1_Re0.050_M0.00_N9.0_360_M.dat');


alpha_t=T_0025(13:end,1);
CD_t=T_0025(13:end,2);
CL_t=T_0025(13:end,3);
CM_t=zeros(size(T_0025(13:end,1)));
figure()
plot(alpha_t,CL_t,'r');
hold on
plot(alpha_t,CD_t,'b');
...
theta=0*pi/180;
phi=86*pi/180; %Portandolo a 90 si tende a stringere il cerchio
...
% 
% end
%     Fin_(i,:)=[ YOUT(end,10)  YOUT(end,11)  YOUT(end,12)];
%     Dist(i)=norm( Fin_(i,:));
% end
%% Plot
