...
l=0.2800; % lunghezza della pala avente un profilo 2D definito, NON corrisponde alla lunghezza del boomerang
Chord=l/4.1000;
delta= 34.6400*pi/180; %Angolo di freccia
...
D=pi/4;
theta=8*pi/180;
A = BoomSpotArea(BoomInfo,200,D,theta,Chi,'prova')
