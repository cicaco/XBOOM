...
%BET
for i=1:length(eta1)
    fa1=(span1(i+1)-span1(i))*0.5*1.225*c*norm(w1(:,i))^2*[-CL_naca0012(AoA1(i))*sin(AoA1(i))+CD_naca0012(AoA1(i))*cos(AoA1(i)); 0; CL_naca0012(AoA1(i))*cos(AoA1(i))+CD_naca0012(AoA1(i))*sin(AoA1(i))];
    ma1=(span1(i+1)-span1(i))*0.5*1.225*c*norm(w1(:,i))^2*[(CL_naca0012(AoA1(i))*cos(AoA1(i))+CD_naca0012(AoA1(i))*sin(AoA1(i)))*eta1(i); c*CM_naca0012(AoA1(i)); (CL_naca0012(AoA1(i))*sin(AoA1(i))-CD_naca0012(AoA1(i))*cos(AoA1(i)))*eta1(i)];
    fa2=(span2(i+1)-span2(i))*0.5*1.225*c*norm(w2(:,i))^2*[-CL_naca0012(AoA2(i))*sin(AoA2(i))+CD_naca0012(AoA2(i))*cos(AoA2(i)); 0; CL_naca0012(AoA2(i))*cos(AoA2(i))+CD_naca0012(AoA2(i))*sin(AoA2(i))];
    ma2=(span2(i+1)-span2(i))*0.5*1.225*c*norm(w2(:,i))^2*[(CL_naca0012(AoA2(i))*cos(AoA2(i))+CD_naca0012(AoA2(i))*sin(AoA2(i)))*eta2(i); c*CM_naca0012(AoA2(i)); (CL_naca0012(AoA2(i))*sin(AoA2(i))-CD_naca0012(AoA2(i))*cos(AoA2(i)))*eta2(i)];
    %forze su sdr body
    f1=(Tj1')*fa1;
